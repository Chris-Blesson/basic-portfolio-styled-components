    ...
    <section className="projects" id="projects">
      ...
      <article>
        <div className="text">
          ...
          <H3 className="heading" themeColor={themeColor}>My Portfolio</H3>
      ...
      <article>
        <div className="text">
          <H3 themeColor={themeColor}>Virtual Fashion</H3>
      ...
      <article>
        <div className="text">
          <H3 themeColor={themeColor}>Ember Songs</H3>
      ...
      <article>
        <div className="text">
          <H3 themeColor={themeColor}>Freshbills</H3>
